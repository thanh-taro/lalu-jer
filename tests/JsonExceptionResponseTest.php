...
class JsonExceptionResponseTest extends \PHPUnit_Framework_TestCase
{
    public function testBasic()
    {
        ...
        $instance = new JsonExceptionResponse(['version' => '1.0.0']);
    ...
    public function testGetResponse()
    {
        ...
        $this->assertJsonApi($response, 500, $exception, '{"jsonapi":{"version":"1.0.0"},"meta":{"version":"1.0"},"errors":[{"title":"Error title","detail":"This is an error"}]}', ['Custom' => 'Header']);
        $jer = new JsonExceptionResponse($option, $attributes);
        ...
        $this->assertJsonApi($response, 400, $exception, '{"jsonapi":{"version":"1.0.0"},"meta":{"version":"1.0"},"errors":[{"title":"Error title","detail":"This is an error"}]}', ['Custom' => 'Header']);
    }
